import { Box, Card, CardActionArea, CardActions, CardContent, CardMedia, Container, Grid, LinearProgress, Typography } from '@mui/material';
                                ...
                                <Grid key={service.id} className={service.class} item xs={12} md={6} lg={4}>
                                    ...
                                    <Card sx={{
                                        ...
                                        <CardActionArea>
                                            ...
                                            />
                                            <CardContent sx={{ display: 'flex', mx: 5, my: 2 }}>
                                                {/* <Avatar
                                                    alt="service icon"
                                                    src={service?.icon}
                                                    sx={{
